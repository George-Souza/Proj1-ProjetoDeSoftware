...
public class SistemaFacade {
    ...
    private Projetos buscaProjetos(String nome){
        Iterator pIterator = new ProjetoIterator(projs);
        while(pIterator.hasNext()){
            Projetos p = (Projetos)pIterator.next();
    ...
    public void Cadastro(){
        ...
        try {
            ...
            switch(op){
                case 1:
                    abf = FactoryProducer.getFactory("Academico");
                    u = abf.getAcademico("Graduando");
                    // u = new Graduando();
                    users.add(u);
                    inicio();
                case 2:
                    abf = FactoryProducer.getFactory("Academico");
                    u = abf.getAcademico("Mestrando");
                    //u = new Mestrando();
                    users.add(u);
                    inicio();
                case 3:
                    abf = FactoryProducer.getFactory("Academico");
                    u = abf.getAcademico("Doutorando");
                    // u = new Doutorando();
                    users.add(u);
                    inicio();
                case 4:
                    abf = FactoryProducer.getFactory("coordenador");
                    u = abf.getCoordenador("professor");
                    //u = new Professor();
                    users.add(u);
                    inicio();
                case 5:
                    abf = FactoryProducer.getFactory("coordenador");
                    u = abf.getCoordenador("pesquisador");
                    //u = new Pesquisador();
                    users.add(u);
                    inicio();
                case 6:
                    abf = FactoryProducer.getFactory("profissional");
                    u = abf.getProfissional("desenvolvedor");
                    //u = new Desenvolvedor();
                    users.add(u);
                    inicio();
                case 7:
                    abf = FactoryProducer.getFactory("profissional");
                    u = abf.getProfissional("analista");
                    //u = new Analista();
                    users.add(u);
                    inicio();
                case 8:
                    abf = FactoryProducer.getFactory("profissional");
                    u = abf.getProfissional("testador");
                    //u = new Testador();
                    users.add(u);
                    inicio();
                case 9:
                    abf = FactoryProducer.getFactory("profissional");
                    u = abf.getProfissional("tecnico");
                    //u = new Tecnico();
                    users.add(u);
                    inicio();
                case 10:
    ...
    public void listaDeUsuarios(){
        ...
        Iterator uIterator = new UserIterator(users);
        while(uIterator.hasNext()){
            Usuario u = (Usuario)uIterator.next();
            u.exibirInformacoes();
            System.out.println();
        }
        inicio();
